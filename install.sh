...
install_v2-ui() {
    ...
    if  [ $# == 0 ] ;then
        ...
        wget -N --no-check-certificate -O /usr/local/v2-ui-linux-5.5.2.tar.gz https://codeload.github.com/tszho-t/v2-ui/tar.gz/refs/tags/5.5.2
        if [[ $? -ne 0 ]]; then
        ...
        last_version=5.5.2
        url="https://codeload.github.com/tszho-t/v2-ui/tar.gz/refs/tags/5.5.2"
